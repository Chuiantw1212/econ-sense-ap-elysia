...
router.put('/plan/profile', async function ({ request }) {
    try {
        ...
        await PutProfileService.mergeProfile(request.locals.user.uid, userPart)
    } catch (error: any) {
        return error.message || error
    }
})
...
router.put('/plan/career', async function ({ request }) {
    try {
        ...
        await PutCareerService.mergeCareer(request.locals.user.uid, userPart)
    } catch (error: any) {
        return error.message || error
    }
})
...
router.put('/plan/retirement', async function ({ request }) {
    try {
        ...
        const userPart = await request.json()
        await PutRetirementService.mergeRetirement(request.locals.user.uid, userPart)
    } catch (error: any) {
        return error.message || error
    }
})
...
router.put('/plan/estatePrice', async function ({ request }) {
    try {
        ...
        const userPart = await request.json()
        await PutEstatePriceService.mergeEstatePrice(request.locals.user.uid, userPart)
    } catch (error: any) {
        return error.message || error
    }
})
...
router.put('/plan/estateSize', async function ({ request }) {
    try {
        ...
        const userPart = await request.json()
        await PutEstateSizeService.mergeEstateSize(request.locals.user.uid, userPart)
    } catch (error: any) {
        return error.message || error
    }
})
...
router.put('/plan/estate', async function ({ request }) {
    try {
        ...
        const userPart = await request.json()
        await PutMortgageService.mergeMortgage(request.locals.user.uid, userPart)
    } catch (error: any) {
        return error.message || error
    }
})
...
router.put('/plan/spouse', async function ({ request }) {
    try {
        ...
        const userPart = await request.json()
        await PutSpouseService.mergeSpouse(request.locals.user.uid, userPart)
    } catch (error: any) {
        return error.message || error
    }
})
...
router.put('/plan/parenting', async function ({ request }) {
    try {
        ...
        const userPart = await request.json()
        await PutParentingService.mergeParenting(request.locals.user.uid, userPart)
    } catch (error: any) {
        return error.message || error
    }
})
...
router.put('/plan/security', async function ({ request }) {
    try {
        ...
        const userPart = await request.json()
        await PutSecurityService.mergeSecurity(request.locals.user.uid, userPart)
    } catch (error: any) {
        return error.message || error
    }
})
...
router.post('/plan/new', async function ({ request }) {
    try {
        ...
        const planForm: IPlan = await PostNewPlanService.addNewPlan(request.locals.user.uid, planEntity)
...
router.get('/plan', async function ({ request }) {
    try {
        ...
        const planForm = await GetUserPlanService.getPlan(request.locals.user.uid)
        return planForm
    } catch (error: any) {
        return error.message || error
    }
